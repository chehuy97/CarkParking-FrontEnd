...
export default {
  ...
  home_parkingDetail_radius: 10,
  home_detailName_marginHorizontal: 20,
  home_detailName_marginTop: 10,
  home_detailAddressCard_height: 25,
  home_detailTimeIcon_marginLeft: 20,
